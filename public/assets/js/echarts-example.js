(function (factory) {
  ...
  const basicAreaLineChartInit = () => {
    ...
    const $chartEl = document.querySelector('.graphCanvas_total_sale');
    const months = [
      'January',
      'February',
      'March',
    ...
    const data = [
	document.getElementById('Jan').innerText,
    document.getElementById('Feb').innerText,
    document.getElementById('Mar').innerText,
    document.getElementById('Apr').innerText,
    document.getElementById('May').innerText,
    document.getElementById('Jun').innerText,
    document.getElementById('Jul').innerText,
    document.getElementById('Aug').innerText,
    document.getElementById('Sep').innerText,
    document.getElementById('Oct').innerText,
    document.getElementById('Nov').innerText,
