                ...
                <div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom border-300 bg-soft">
                    <div class="row g-3 justify-content-between align-items-center">
                      <div class="col-12 col-md">
                        <h4 class="text-900 mb-0"> Edit Product</h4>
                      </div>
                  ...
                  <div class="card-body p-0">
                    ...
                    <div class="p-4 code-to-copy">
                            <form class="row g-3" action="{{URL::to('updateinverter')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                    ...
                    <select class="form-control" name="product_cat" >
                           ...
                           @foreach($mods as $mod)
                            <option value="{{$mod->name}}" @if($proposals->product_cat ==$mod->name) selected @endif>{{$mod->name}}</option>
                           @endforeach
                          </select>
            </div>
            
             <div class="col-md-4 position-relative">
                                                <label class="form-label" for="userinput1">Product Name</label>
...
<input type="text" required id="userinput1" class="form-control" name="price" value="{{old('title',$proposals->price)}}" tabindex="1">
                                       </div>
									 
                                     	
                                        <div class="col-md-4 position-relative">
                                                <label class="form-label" for="userinput1">Discount</label>
 <input type="text" required id="userinput1" class="form-control" name="discount" value="{{old('title',$proposals->discount)}}" tabindex="1">
                                       </div>
