...
<html lang="en-US" dir="ltr">
  ...
  <head>
   ...
   <title>{{isset($title)?'Food App- '.$title:'Food App Portal'}}</title>
    ...
    <footer class="footer position-absolute">
          <div class="row g-0 justify-content-between align-items-center h-100">
            <div class="col-12 col-sm-auto text-center">
              <p class="mb-0 mt-2 mt-sm-0 text-900">All rights reserved<span class="d-none d-sm-inline-block"></span><span class="d-none d-sm-inline-block mx-1">|</span><br class="d-sm-none" />2025 &copy;<a class="mx-1" href="https://www.heliogt.com">Food App</a></p>
            </div>
