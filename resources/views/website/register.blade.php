              ...
              <div class="card-body pe-md-0">
                <div class="row align-items-center gx-0 gy-7">
                  <div class="col-auto bg-100 dark__bg-1100 rounded-3 position-relative overflow-hidden auth-title-box">
					...
					<img class="auth-title-box-img d-light-none" src="{{ asset('assets/img/bg/login.webp') }}" alt="" /></div>
                  </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-wrap">
                                    ...
                                    <input type="text" name="first_name" value="{{old('first_name')}}"  class="form-control" required id="exampleInputEmail1" placeholder="Enter your first name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-wrap">
                                    <label for="exampleInputEmail1" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" value="{{old('last_name')}}" name="last_name" id="exampleInputEmail1" placeholder="Enter your last name">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-wrap">
                            ...
                            <div class="col-md-12">
                                <div class="form-wrap">
                                    ...
                                    <input type="number" class="form-control inner-page-input" name="contact_number" value="{{old('contact_number')}}" id="exampleInputEmail1" placeholder="Phone Number">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-wrap">
