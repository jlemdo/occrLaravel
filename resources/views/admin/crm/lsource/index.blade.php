  ...
  <div id="members" data-list='{"valueNames":["customer","email","city","last_active","joined"],"page":10,"pagination":true}'>
          <div class="row align-items-center justify-content-between g-3 mb-4">
            <div class="col col-auto">
              <h2 class="text-bold text-1100">Lead Source</h2>
            </div>
            <div class="col-auto">
              <div class="d-flex align-items-center">
               
                <a href="{{URL::to('newlead_source')}}" class="btn btn-phoenix-primary"><span class="fas fa-plus me-2"></span>Add New</a>
...
<a class="btn btn-phoenix-success btn-sm" href="{{URL::to('lead_sourceEdit/'.$project->id)}}"><span class="fa fa-edit"></span></a>

<form id="destroy-data{{ $i }}" action="{{ route('deletelead_source', $project->id)}}" method="post">
                                                @csrf
