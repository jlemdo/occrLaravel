...
@section('section')
  ...
  <div id="members" data-list='{"valueNames":["customer","email","mobile_number","city","joined"],"page":10,"pagination":true}'>
          <div class="row align-items-center justify-content-between g-3 mb-4">
            <div class="col col-auto">
             <h2 class="text-bold text-1100">Deal Stages</h2>
            </div>
            <div class="col-auto">
              <div class="d-flex align-items-center">
               
                <a href="{{URL::to('newdeal_stage')}}" class="btn btn-phoenix-primary"><span class="fas fa-plus me-2"></span>Add New</a>
...
<a class="btn btn-phoenix-success btn-sm" href="{{URL::to('deal_stageEdit/'.$project->id)}}"><span class="fa fa-edit"></span></a>

<form id="destroy-data{{ $i }}" action="{{ route('deletedeal_stage', $project->id)}}" method="post">
                                                @csrf
