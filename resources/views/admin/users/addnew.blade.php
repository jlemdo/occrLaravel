                    ...
                    <div class="card-header p-4 border-bottom" style="background: white; border: 1px solid #dee2e6; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                        <div class="row g-3 justify-content-between align-items-center">
                            <div class="col-12 col-md">
                                ...
                                <p class="text-muted mb-0 small">Complete la información del nuevo usuario</p>
                            </div>
                    ...
                    <div class="card-body p-0">
                        <div class="p-4">
                            <form method="post" action="{{route('registeradmin')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="first_name" name="first_name" 
                                                       value="{{old('first_name')}}" required placeholder="Nombre">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="last_name" name="last_name" 
                                                       value="{{old('last_name')}}" required placeholder="Apellido">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="tel" class="form-control" id="contact_number" name="contact_number" 
                                                       value="{{old('contact_number')}}" required placeholder="Teléfono">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <select class="form-select" id="usertype" name="usertype" required>
                                                    ...
                                                    <option value="driver" {{old('usertype') == 'driver' ? 'selected' : ''}}>🚚 Conductor</option>
                                                    <option value="customer" {{old('usertype') == 'customer' ? 'selected' : ''}}>🛒 Cliente</option>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <textarea class="form-control" id="address" name="address" 
                                                         placeholder="Dirección" style="height: 100px">{{old('address')}}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <textarea class="form-control" id="intro" name="intro" 
                                                         placeholder="Introducción" style="height: 100px">{{old('intro')}}</textarea>
                                ...
                                <div class="form-section">
                                    <h5 class="section-title">
                                        <i class="fas fa-camera text-secondary"></i>Foto de Perfil
                                    </h5>
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="upload-area">
                                                ...
                                                <label for="profile_photo" style="cursor: pointer; width: 100%;">
                                                    ...
                                                    <p class="mb-0"><strong>Hacer clic para subir foto</strong></p>
                                        ...
                                        <div class="col-md-4">
                                            <div class="text-center">
                                                ...
                                                <p class="text-muted small mt-2">Vista previa de la imagen</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
