          ...
          <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6 text-lg-start text-center pt-8 pb-6 order-0 position-relative">
              ...
              <div class="mb-4 p-3 bg-light rounded">
                <h5>🔐 Control OTP Email</h5>
                <p class="mb-2">Estado actual: <span id="otp-status" class="badge">Cargando...</span></p>
                <button id="toggle-otp" class="btn btn-primary" onclick="toggleOTP()">Toggle OTP</button>
              </div>
